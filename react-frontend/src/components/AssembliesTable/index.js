...
// import AssemblyInfoListItem from "../../screens/MainRouter/components/AssembliesList/components/AssembliesListElement";
...
//     if (userID && token) {
//       await fetchAssemblies(search, page - 1, range, userID, token, bookmarksUserID ? 1 : 0).then(
//         (response) => {
