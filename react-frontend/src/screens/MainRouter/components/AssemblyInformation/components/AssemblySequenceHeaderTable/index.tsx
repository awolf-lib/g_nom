...
const AssemblySequenceHeaderTable = ({
  ...
  return (
    <div className="animate-fade-in">
      <div className="flex bg-gray-600 text-white font-semibold py-1 border-b">
      ...
      <div className="flex justify-around items-center w-full py-2 bg-gray-600 text-white select-none">
        <div className="flex items-center hover:bg-gray-500 cursor-pointer rounded-lg p-1 w-80">
          <Input
            placeholder="Search..."
        ...
        <div className="flex justify-around items-center">
          <div
            className="flex items-center hover:bg-gray-500 cursor-pointer rounded-lg py-1 px-4"
