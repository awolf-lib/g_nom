...
CREATE TABLE IF NOT EXISTS `gnom_db`.`assemblies` (
  ...
  `n50` INT NOT NULL,
  `n90` INT NOT NULL,
  `shortestSequence` INT NOT NULL,
  `largestSequence` INT NOT NULL,
  `meanSequence` INT NOT NULL,
  `medianSequence` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `gnom_db`.`genomicAnnotationSequences`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gnom_db`.`genomicAnnotationSequences` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `annotationID` INT NOT NULL,
  `header` VARCHAR(200) NOT NULL,
  `headerIdx` INT NOT NULL,
  `sequenceLength` INT NOT NULL,
  `descriptionString` VARCHAR(400) NOT NULL,
  PRIMARY KEY (`id`),
